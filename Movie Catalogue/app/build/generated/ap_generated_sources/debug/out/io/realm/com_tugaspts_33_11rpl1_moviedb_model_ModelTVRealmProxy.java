...
public class com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxy extends com.tugaspts_33_11rpl1.moviedb.model.ModelTV
    implements RealmObjectProxy, com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.tugaspts_33_11rpl1.moviedb.model.ModelTV> proxyState;

    com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.tugaspts_33_11rpl1.moviedb.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.tugaspts_33_11rpl1.moviedb.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.tugaspts_33_11rpl1.moviedb.model.ModelTV obj = realm.createObjectInternal(com.tugaspts_33_11rpl1.moviedb.model.ModelTV.class, true, excludeFields);

        final com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface objProxy = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.tugaspts_33_11rpl1.moviedb.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.tugaspts_33_11rpl1.moviedb.model.ModelTV obj = new com.tugaspts_33_11rpl1.moviedb.model.ModelTV();
        final com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface objProxy = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.tugaspts_33_11rpl1.moviedb.model.ModelTV copyOrUpdate(Realm realm, com.tugaspts_33_11rpl1.moviedb.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.tugaspts_33_11rpl1.moviedb.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.tugaspts_33_11rpl1.moviedb.model.ModelTV copy(Realm realm, com.tugaspts_33_11rpl1.moviedb.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.tugaspts_33_11rpl1.moviedb.model.ModelTV realmObject = realm.createObjectInternal(com.tugaspts_33_11rpl1.moviedb.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface realmObjectSource = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) newObject;
        com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface realmObjectCopy = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.tugaspts_33_11rpl1.moviedb.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.tugaspts_33_11rpl1.moviedb.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.tugaspts_33_11rpl1.moviedb.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.tugaspts_33_11rpl1.moviedb.model.ModelTV.class);
        com.tugaspts_33_11rpl1.moviedb.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.tugaspts_33_11rpl1.moviedb.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.tugaspts_33_11rpl1.moviedb.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.tugaspts_33_11rpl1.moviedb.model.ModelTV.class);
    ...
    public static com.tugaspts_33_11rpl1.moviedb.model.ModelTV createDetachedCopy(com.tugaspts_33_11rpl1.moviedb.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.tugaspts_33_11rpl1.moviedb.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.tugaspts_33_11rpl1.moviedb.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.tugaspts_33_11rpl1.moviedb.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.tugaspts_33_11rpl1.moviedb.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface unmanagedCopy = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface realmSource = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxy aModelTV = (com_tugaspts_33_11rpl1_moviedb_model_ModelTVRealmProxy)o;
